...
namespace SariaMod.Items.Topaz
{
    ...
    public class TopazSariaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<TopazPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            if (projectile.frameCounter >= frameSpeed)
            {
                ...
                if (projectile.ai[0] == 2)
                {
                    ...
                    if (base.projectile.frame == 78)
                    {
                        ...
                        if (target != null) Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 10f, ModContent.ProjectileType<TopazPsychicBlade>(), base.projectile.damage, 0f, base.projectile.owner); //here is the attack that she fires when attacking enemies
