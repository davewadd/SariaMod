...
{
	public class TopazPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!mother.active || mother.type != ModContent.ProjectileType<TopazSariaMinion>())
			{
				base.projectile.Kill();
				return;
			}
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<TopazPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
