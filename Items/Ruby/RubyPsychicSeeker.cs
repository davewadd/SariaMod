	...
	public class RubyPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<RubyPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
