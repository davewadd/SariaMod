...
namespace SariaMod.Items.Ruby
{
    public class RubyPsychicSeeker : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // PRIORITY: ZtargetReal (owned by same player), ignores LOS
            if (Projectile.TryGetOwnedZtargetRealTarget(2000f, out Vector2 zTargetCenter))
            {
                targetCenter = zTargetCenter;
                foundTarget = true;
