...
namespace SariaMod.Items.Ruby
{
    ...
    public class RubySariaMinion : ModProjectile
    {
        ...
        {
            target.AddBuff(31, 120); //confusion
            target.AddBuff(24, 120); //on fire
            target.AddBuff(323, 120); //hell fire
            target.AddBuff(67, 120); //burning
            target.AddBuff(32, 120); //slowness
            target.AddBuff(47, 120); //frozen
        }
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<RubyPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            if (projectile.frameCounter >= frameSpeed)
            {
                ...
                if (projectile.ai[0] == 2)
                {
                    ...
                    if (base.projectile.frame == 78)
                    {
                        ...
                        if (target != null) Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 10f, ModContent.ProjectileType<RubyPsychicBlade>(), base.projectile.damage, 0f, base.projectile.owner); //here is the attack that she fires when attacking enemies
