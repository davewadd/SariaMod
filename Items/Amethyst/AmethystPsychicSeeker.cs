...
{
	public class AmethystPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!mother.active || mother.type != ModContent.ProjectileType<AmethystSariaMinion>())
			{
				base.projectile.Kill();
				return;
			}
			...
			if (target != null)
			{
				...
				if (base.projectile.ai[1] % 55f == 54f && Main.myPlayer == base.projectile.owner)
				{
					...
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<AmethystPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
