...
namespace SariaMod.Items.Amethyst
{
    ...
    public class AMESariaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if ((player.HasBuff(ModContent.BuffType<AmethystSariaBuff>()) && (player.ownedProjectileCounts[ModContent.ProjectileType<AMASariaMinion>()] > 0f)))
            {
                projectile.Kill();
            }
