...
{
	public class DiamondEmeraldPsychicBeam : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Main.PlaySound(base.mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/EmeraldBeam"), base.projectile.Center);
			}
		}	
	}
}
