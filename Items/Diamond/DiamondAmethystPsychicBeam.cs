...
{
	public class DiamondAmethystPsychicBeam : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Main.PlaySound(base.mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/GhostBeam"), base.projectile.Center);
			}
		}	
	}
}
