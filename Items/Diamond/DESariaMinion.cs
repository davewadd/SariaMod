...
namespace SariaMod.Items.Diamond
{
    ...
    public class DESariaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<ZtargetD6>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            if ((player.HasBuff(ModContent.BuffType<DiamondSariaBuff>()) && (player.ownedProjectileCounts[ModContent.ProjectileType<DASariaMinion>()] > 0f)))
            {
                projectile.Kill();
            }
