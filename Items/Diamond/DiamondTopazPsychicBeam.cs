...
{
	public class DiamondTopazPsychicBeam : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Main.PlaySound(base.mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/ElectricBeam"), base.projectile.Center);
			}
		}	
	}
}
