...
{
	public class AmberPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!mother.active || mother.type != ModContent.ProjectileType<AmberSariaMinion>())
			{
				base.projectile.Kill();
				return;
			}
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<AmberPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
