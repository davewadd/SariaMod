	...
	public class AmberPurple: ModProjectile
	{
        ...
        public override void AI()
		{
			...
			if (projectile.timeLeft == 10)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center + new Vector2( 0f, 0f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<PurpleMoth>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
				}
			}
