...
namespace SariaMod.Items.Amber
{
	public class PurpleMoth: ModProjectile
	{
		...
		public override void AI()
		{
            ...
            {
				{
					...
					Projectile.NewProjectile(base.projectile.Center + new Vector2(0f, 0f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PurpleMothGiant>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
				}
			}
            ...
            {
				{
					Projectile.NewProjectile(base.projectile.Center + new Vector2(0f, -100f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PurpleHealthBar>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
				}
			}
				if (foundTarget)
                {
