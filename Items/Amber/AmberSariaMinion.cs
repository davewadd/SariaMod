    ...
    public class AmberSariaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                for (int j = 0; j < 1; j++) //set to 2
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<ZtargetA>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            if ((player.HasBuff(ModContent.BuffType<AmberSariaBuff>()) && (player.ownedProjectileCounts[ModContent.ProjectileType<ASariaMinion>()] > 0f)))
            {
                projectile.Kill();
            }
