...
namespace SariaMod.Items.zBookcases
{
    public class SariaSecondFormNote : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("~ColdSoul will slowely attack your enemies!\n~Enemies hit will have some Hp stolen\n " + "\n " + MiscUtilities.ColorMessage("Now allows you to walk and breath in water", new Color(0, 200, 250, 200)) + "\n " + MiscUtilities.ColorMessage("Super effective in:", new Color(0, 200, 250, 200)) + "\n" + MiscUtilities.ColorMessage("~Hell, Rain, Beach, Meteor, and by a WaterCandle", new Color(0, 200, 250, 200)) + "\n " + "\n " + MiscUtilities.ColorMessage("Not very effective in:", new Color(135, 206, 180)) + "\n" + MiscUtilities.ColorMessage(" ~Desert, Jungle, and Glowshroom", new Color(135, 206, 180)));
        }
