...
{
	public class PlatinumPurpleAmethystPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Lighting.AddLight(projectile.Center, Color.MediumPurple.ToVector3() * 0.78f);
			...
			if (!mother.active || mother.type != ModContent.ProjectileType<PlatinumPurpleSariaMinion>())
			{
				base.projectile.Kill();
				return;
			}
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<DiamondAmethystPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
