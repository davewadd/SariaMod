...
namespace SariaMod.Items.Platinum
{
    ...
    public class PlatinumPurpleSariaMinion : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            base.projectile.minionSlots = 18f;
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurplePsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleSapphirePsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleRubyPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleTopazPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleEmeraldPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleAmberPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<PlatinumPurpleAmethystPsychicSeeker>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            {
                player.ClearBuff(ModContent.BuffType<PlatinumPurpleSariaBuff>());
                projectile.Kill();
            }
            ...
            else if (!player.HasBuff(ModContent.BuffType<PlatinumPurpleSariaBuff>()))
            {
                projectile.Kill();
            }
            ...
            if (projectile.frameCounter >= frameSpeed)
            {
                ...
                if (projectile.frame >= Main.projFrames[ModContent.ProjectileType<PlatinumPurpleSariaMinion>()]) //error here! you had the wrong projectile id, so the animation did not use the right frames
                {
                    projectile.frame = 0;
                ...
                if (projectile.ai[0] == 0 || projectile.ai[0] == 3 || projectile.ai[0] == 4) //only run these animations if not attacking! no longer overrides
                {
                    ...
                    if ((player.velocity.Y) < 4f && Math.Abs(player.velocity.X) >= 4f)//running or (floating) animation
                    {
                        projectile.frame++;
                    ...
                    if ((player.velocity.Y) < -3f) //rising animation
                    {
                        projectile.frame++;
                    ...
                    if (player.velocity.Y > 4f) //falling animation
                    {
                        projectile.frame++;
                ...
                if (projectile.ai[0] == 2)
                {
                    ...
                    if (base.projectile.frame == 78)
                    {
                        ...
                        if (target != null) Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 10f, ModContent.ProjectileType<DiamondBlackHole>(), base.projectile.damage, 0f, base.projectile.owner); //here is the attack that she fires when attacking enemies
