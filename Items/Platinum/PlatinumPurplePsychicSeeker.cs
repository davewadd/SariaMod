...
{
	public class PlatinumPurplePsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<DiamondBigPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
