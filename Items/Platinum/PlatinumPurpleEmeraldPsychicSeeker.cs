...
{
	public class PlatinumPurpleEmeraldPsychicSeeker : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Lighting.AddLight(projectile.Center, Color.LightSeaGreen.ToVector3() * 0.78f);
			...
			if (target != null)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center, base.projectile.DirectionTo(target.Center) * 19f, ModContent.ProjectileType<DiamondEmeraldPsychicBeam>(), mother.damage, mother.knockBack, mother.owner);
				}
			}
