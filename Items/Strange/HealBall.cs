...
namespace SariaMod.Items.Strange
{
    public class HealBall : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault(MiscUtilities.ColorMessage("Calls on Saria, the Champion of Foresight!", new Color(135, 206, 180)) + "\n" + MiscUtilities.ColorMessage("Requires 3 minion slots to summon but doens't occupy the slots", new Color(50, 200, 250)) + "\n" + MiscUtilities.ColorMessage("Saria will level up as you battle with her!", new Color(0, 200, 250, 200)) + "\n " + MiscUtilities.ColorMessage("As she levels up, she learns new attacks and gives added buffs depending on what biome she is in", new Color(0, 200, 250, 200)) + "\n" + MiscUtilities.ColorMessage("Left Click to change available forms, Hold left to start a charged attack!", new Color(0, 20, 250, 200)) + "\n " + MiscUtilities.ColorMessage("You must hold the Pokeball for Saria to target enemies!", new Color(0, 20, 250, 200)));
