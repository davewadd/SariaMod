...
{
    public abstract class BaseLaunchHitBox : ModProjectile
    {
        protected virtual int HitBoxWidth => 200;
        protected virtual int HitBoxHeight => 250;
        protected virtual int DamageMultiplier => 2;
        protected virtual int DebuffDuration => 20;
        protected abstract int EmeraldspikeType { get; }
        ...
        {
            base.Projectile.width = HitBoxWidth;
            base.Projectile.height = HitBoxHeight;
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            ...
            target.AddBuff(ModContent.BuffType<MeteorLaunchDebuff>(), DebuffDuration);
        ...
        public override void AI()
        {
            ...
            int GiantMoth = EmeraldspikeType;
