...
{
    public class RupeeShard3 : BaseRupeeShard
    {
        protected override Color LightColor => Color.Green;
        protected override int InitialTimeLeft => 1500;
        protected override int BouncingShardType => ModContent.ProjectileType<BouncingShard3>();
