...
{
	public class PurpleGemBallProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (projectile.timeLeft == 10)
			{
				...
				if ((player.ownedProjectileCounts[ModContent.ProjectileType<Emeraldfairy>()] <= 0f))
				{
					...
					Projectile.NewProjectile(projectile.Center, Utils.NextVector2Circular(Main.rand, 0, 2), ModContent.ProjectileType<EmeraldfairyGem>(), projectile.damage, projectile.knockBack, player.whoAmI);
					Projectile.NewProjectile(projectile.Center, Utils.NextVector2Circular(Main.rand, 12f, 12f), ModContent.ProjectileType<ReturnBallPurple>(), projectile.damage, projectile.knockBack, player.whoAmI);
					Projectile.NewProjectile(projectile.Center, Utils.NextVector2Circular(Main.rand, 0, 2), ModContent.ProjectileType<Emeraldfairy>(), projectile.damage, projectile.knockBack, player.whoAmI);
				}
				else
                {

					Projectile.NewProjectile(projectile.Center + Utils.NextVector2CircularEdge(Main.rand, 8f, 8f), Utils.NextVector2Circular(Main.rand, 12f, 12f), ModContent.ProjectileType<ReturnBallPurple>(), projectile.damage, projectile.knockBack, player.whoAmI);
				}
			}
