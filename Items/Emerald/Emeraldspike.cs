	...
	public class Emeraldspike : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (projectile.timeLeft <= 50)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<Crystalshard>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
				}
				Main.PlaySound(SoundID.DD2_WitherBeastCrystalImpact, base.projectile.Center);
				projectile.Kill();
			}
