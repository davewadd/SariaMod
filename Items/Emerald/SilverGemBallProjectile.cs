...
{
	public class SilverGemBallProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Projectile.timeLeft == 10)
			{
				...
				{
					SoundEngine.PlaySound(new SoundStyle("SariaMod/Sounds/Pokeball"));
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<ReturnBallSilver>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<EmeraldfairySilver>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
