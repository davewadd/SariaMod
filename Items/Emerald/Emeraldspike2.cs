	...
	public class Emeraldspike2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (projectile.timeLeft <= 50)
			{
				...
				{
					Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<Crystalshard2>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
				}
				Main.PlaySound(SoundID.DD2_WitherBeastCrystalImpact, base.projectile.Center);
				projectile.Kill();
			}
		...
		public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
		{
			...
			if ((projectile.timeLeft >= 10 && projectile.timeLeft <= 500))

			{
				{
					
					Item.NewItem(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ItemType<Rupee3>());
				}
			}
			if (player.HasBuff(ModContent.BuffType<StatRaise>()))
			{
