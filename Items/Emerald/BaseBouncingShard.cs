...
{
    public abstract class BaseBouncingShard : ModProjectile
    {
        protected virtual Color LightColor => Color.Green;
        protected virtual int InitialTimeLeft => 1600;
        protected virtual Color TrailColor => Color.Green;
        ...
        {
            {
                Texture2D starTexture2 = TextureAssets.Projectile[base.Projectile.type].Value;
                Texture2D starTexture = TextureAssets.Projectile[base.Projectile.type].Value;
                ...
                for (int i = 1; i < base.Projectile.oldPos.Length; i++)
                {
                    ...
                    drawColor = Color.Lerp(drawColor, TrailColor, completionRatio);
