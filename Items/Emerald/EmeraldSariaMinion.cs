    ...
    public class EmeraldSariaMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (base.projectile.localAI[0] == 0f)
            {
                ...
                {
                    Projectile.NewProjectile(base.projectile.Center + Utils.RandomVector2(Main.rand, -24f, 24f), Vector2.One.RotatedByRandom(6.2831854820251465) * 1f, ModContent.ProjectileType<ZtargetE>(), base.projectile.damage, base.projectile.knockBack, player.whoAmI, base.projectile.whoAmI);
                }
            ...
            if (player.HasBuff(ModContent.BuffType<EmeraldSariaBuff>()) && projectile.timeLeft <= 10)
            {
            ...
            if ((player.HasBuff(ModContent.BuffType<EmeraldSariaBuff>()) && (player.ownedProjectileCounts[ModContent.ProjectileType<ESariaMinion>()] > 0f)))
            {
                projectile.Kill();
            }
