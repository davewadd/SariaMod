...
namespace SariaMod.Items.zPearls
{
	...
	public class EclipseOcarina : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("EclipseOcarina");
			Tooltip.SetDefault("Left click to choose song\n Right click to play song\nCan cause or stop Eclipses");
		}
		...
		public override void Update(ref float gravity, ref float maxFallSpeed)
		{
			...
			Lighting.AddLight(item.Center, Color.Black.ToVector3() * 2f);
		}
		...
		public override bool CanUseItem(Player player)
		{
			...
			if (player.altFunctionUse != 2 && (player.ownedProjectileCounts[ModContent.ProjectileType<EclipseNote>()] == 0f) && (player.ownedProjectileCounts[ModContent.ProjectileType<NotePlay>()] == 0f))
			{
				item.UseSound = base.mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/SongCorrect");
